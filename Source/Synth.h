...
public:
  ...
  void render(const float *readPtr, float *writePtr, int numSamples);
  void record(const float *readPtr, float *writePtr, int numSamples);
  void clearBuffer(float *writePtr, int numSamples);
